...
CREATE INDEX idx_garden_connections_source_id ON garden_connections(source_id);
CREATE INDEX idx_garden_connections_target_id ON garden_connections(target_id);

-- Add sample connections from the static data to verify functionality
INSERT INTO garden_connections (source_id, target_id, strength, relationship)
VALUES
...
SELECT * FROM garden_connections;
