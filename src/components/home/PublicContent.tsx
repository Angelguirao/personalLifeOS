...
const Section = ({ id, title, children, icon }) => {
  ...
  return (
    <motion.section 
      id={id}
      className="container-narrow pt-16 pb-8"
    ...
    >
      ...
      <Card className="p-8 bg-card/70 backdrop-blur-sm border-none shadow-md hover:shadow-lg transition-shadow duration-300">
...
const PublicContent = () => {
  return (
    <div className="space-y-16 bg-gradient-to-br from-white to-purple-50/20 pt-8 pb-16">
